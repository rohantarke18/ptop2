    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          {selectedIds.size > 0 && (
            <div className="flex flex-wrap items-center gap-2 bg-blue-50 border border-blue-200 px-3 py-1.5 rounded text-xs text-blue-900 font-medium">
              <span>{selectedIds.size} Selected</span>
              <button
                type="button"
                onClick={() => handleBulkStatusChange('In Progress')}
                className="bg-blue-600 hover:bg-blue-700 text-white px-2.5 py-1 rounded text-[11px] font-bold cursor-pointer"
              >
                Mark In Progress
              </button>
              <button
              ...
              <button
                ...
                className="bg-rose-600 hover:bg-rose-700 text-white px-2.5 py-1 rounded text-[11px] font-bold flex items-center gap-1 cursor-pointer"
              >
