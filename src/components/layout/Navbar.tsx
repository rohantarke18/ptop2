        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-1.5 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-slate-300 hidden sm:inline">
              Urban Development & Municipal Grievance Administration
            </span>
          </div>

          <div className="flex items-center gap-4">
            <span className="hidden md:inline text-[11px] text-slate-400">
              Toll-Free Helpline: <strong className="text-slate-200 font-semibold">1800-120-8040</strong> (24x7)
            </span>
                  ...
                  <div className="absolute right-0 mt-2 w-72 bg-white rounded-xl shadow-xl border border-slate-200 py-2 z-50 animate-in fade-in duration-150 font-sans">
                    ...
                    <div className="py-1">
                      ...
                      >
                        ...
                        <span>{isAdminOrOfficer ? 'Administrative Console' : 'Citizen Dashboard'}</span>
                      </Link>
                      <Link
                        to="/track"
                        onClick={() => setUserMenuOpen(false)}
